...
- [JavaScript权威指南 7th PDF]({{ files_server }}/computer-science/programming-languages/dynamic/javascript/JavaScript权威指南（第七版）.pdf)
- [JavaScript高级程序设计 4th PDF]({{ files_server }}/computer-science/programming-languages/dynamic/javascript/JavaScript高级程序设计（第4版）.pdf)
