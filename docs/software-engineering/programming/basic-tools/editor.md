...
- [Vim实用技巧 PDF]({{ files_server }}/software-engineering/programming/basic-tools/editor/Vim实用技巧.pdf)
...
- [Visual Studio Code 权威指南 PDF]({{ files_server }}/software-engineering/programming/basic-tools/editor/Visual%20Studio%20Code%20权威指南.pdf)
...
- [IntelliJ IDEA 中文文档]({{ files_server }}/software-engineering/programming/basic-tools/editor/IntelliJ%20IDEA%20中文文档.epub)
- [PyCharm 中文指南]({{ files_server }}/software-engineering/programming/basic-tools/editor/PyCharm%20中文指南.epub)
